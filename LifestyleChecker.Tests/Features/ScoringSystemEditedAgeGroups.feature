Feature: Calculate Risk Score
  ...
  Scenario: Calculate risk score with all medically negative inputs and age bracket 16-25
  ...
  Scenario: Calculate risk score with all true inputs and age bracket 16-25
		Given I patient aged 18 starts the questionnaire
		And I answer the question 'Do you drink on more than 2 days a week' with true
		And I answer the question 'Do you smoke' with true
  ...
  Scenario: Calculate risk score with all false inputs and age bracket 16-25
		Given I patient aged 18 starts the questionnaire
  ...
  Scenario: Calculate risk score with mixed inputs and age bracket 16-25
		Given I patient aged 18 starts the questionnaire
		And I answer the question 'Do you drink on more than 2 days a week' with true
		And I answer the question 'Do you smoke' with false
		And I answer the question 'Do you exercise more than 1 hour per week' with true
  ...
  Scenario: Calculate risk score with all medically negative inputs and age bracket 16-25, age 25
  ...
  Scenario: Calculate risk score with all true inputs and age bracket 16-25, age 25
		Given I patient aged 25 starts the questionnaire
		And I answer the question 'Do you drink on more than 2 days a week' with true
		And I answer the question 'Do you smoke' with true
		And I answer the question 'Do you exercise more than 1 hour per week' with true
  ...
  Scenario: Calculate risk score with all false inputs and age bracket 16-25, age 25
		Given I patient aged 25 starts the questionnaire
		And I answer the question 'Do you drink on more than 2 days a week' with false
		And I answer the question 'Do you smoke' with false
		And I answer the question 'Do you exercise more than 1 hour per week' with false
  ...
  Scenario: Calculate risk score with mixed inputs and age bracket 16-25, age 25
		Given I patient aged 25 starts the questionnaire
		And I answer the question 'Do you drink on more than 2 days a week' with true
		And I answer the question 'Do you smoke' with false
		And I answer the question 'Do you exercise more than 1 hour per week' with true
  ...
  Scenario: Calculate risk score with all medically negative inputs and age bracket 26-40
		Given I patient aged 28 starts the questionnaire
		And I answer the question 'Do you drink on more than 2 days a week' with true
		And I answer the question 'Do you smoke' with true
		And I answer the question 'Do you exercise more than 1 hour per week' with false
		When I submit the questionnaire
		Then I should see the risk score 7
		And display the message "We think there are some simple things you could do to improve you quality of life, please phone to book an appointment"

  Scenario: Calculate risk score with all true inputs and age bracket 26-40
		Given I patient aged 28 starts the questionnaire
		And I answer the question 'Do you drink on more than 2 days a week' with true
		And I answer the question 'Do you smoke' with true
		And I answer the question 'Do you exercise more than 1 hour per week' with true
  ...
  Scenario: Calculate risk score with all false inputs and age bracket 26-40
		Given I patient aged 28 starts the questionnaire
		And I answer the question 'Do you drink on more than 2 days a week' with false
		And I answer the question 'Do you smoke' with false
		And I answer the question 'Do you exercise more than 1 hour per week' with false
  ...
  Scenario: Calculate risk score with mixed inputs and age bracket 26-40
		Given I patient aged 28 starts the questionnaire
		And I answer the question 'Do you drink on more than 2 days a week' with true
		And I answer the question 'Do you smoke' with false
		And I answer the question 'Do you exercise more than 1 hour per week' with true
