...
{
    [FeatureFile("./Features/ScoringSystemEditedEvaluation.feature")]
    public sealed class ScoringSystemEditedEvaluationTests : Feature
    {
        private int _age;
        ...
        private static Questionnaire SetupQuestionnaire()
        {
            ...
            {
                new() { Answer = "Yes", Score = 1, AgeGroupId = ageGroups[0].Id, AgeGroup = ageGroups[0], QuestionId = questions[0].Id, QuestionnaireQuestion = questions[0], Order = 2 },
                ...
                new() { Answer = "Yes", Score = 3, AgeGroupId = ageGroups[2].Id, AgeGroup = ageGroups[2], QuestionId = questions[0].Id, QuestionnaireQuestion = questions[0], Order = 2 },
                ...
                new() { Answer = "Yes", Score = 2, AgeGroupId = ageGroups[0].Id, AgeGroup = ageGroups[0], QuestionId = questions[1].Id, QuestionnaireQuestion = questions[1], Order = 2 },
                new() { Answer = "Yes", Score = 2, AgeGroupId = ageGroups[1].Id, AgeGroup = ageGroups[1], QuestionId = questions[1].Id, QuestionnaireQuestion = questions[1], Order = 2 },
                new() { Answer = "Yes", Score = 2, AgeGroupId = ageGroups[2].Id, AgeGroup = ageGroups[2], QuestionId = questions[1].Id, QuestionnaireQuestion = questions[1], Order = 2 },
                ...
                new() { Answer = "No", Score = 1, AgeGroupId = ageGroups[0].Id, AgeGroup = ageGroups[0], QuestionId = questions[2].Id, QuestionnaireQuestion = questions[2], Order = 2 },
                new() { Answer = "No", Score = 3, AgeGroupId = ageGroups[1].Id, AgeGroup = ageGroups[1], QuestionId = questions[2].Id, QuestionnaireQuestion = questions[2], Order = 2 },
                ...
                new() { Answer = "No", Score = 1, AgeGroupId = ageGroups[3].Id, AgeGroup = ageGroups[3], QuestionId = questions[2].Id, QuestionnaireQuestion = questions[2], Order = 2 },
            };
